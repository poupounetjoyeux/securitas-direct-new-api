...
class SecuritasOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        arm_night_as_arm_away: bool = self.config_entry.options.get(
            CONF_ARM_AWAY_AS_ARM_NIGHT,
            self.config_entry.data.get(
                CONF_ARM_AWAY_AS_ARM_NIGHT, DEFAULT_ARM_NIGHT_AS_ARM_AWAY
            ),
        )
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_ARM_AWAY_AS_ARM_NIGHT, default=arm_night_as_arm_away): bool,
                vol.Optional(CONF_CHECK_ALARM_PANEL, default=armNightAsArmAway): bool,
