...
DEFAULT_ARM_NIGHT_AS_ARM_AWAY = False
        ...
        DOMAIN: vol.Schema(
            {
                ...
                vol.Optional(CONF_ARM_AWAY_AS_ARM_NIGHT, default=DEFAULT_ARM_NIGHT_AS_ARM_AWAY): bool,
                vol.Optional(
...
class SecuritasHub:
    ...
    def __init__(
        ...
        self.arm_night_as_arm_away: bool = domain_config[CONF_ARM_AWAY_AS_ARM_NIGHT]
